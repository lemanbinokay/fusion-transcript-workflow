################################################################################
# Section 3.2 Identification of Fusion Partner Gene List 
################################################################################
...
# ----Step 8: Setting the R environment ---------------------------------------
...
# ----Step 8: SRR -> tissue / patient lookup table ----------------------------
...
# ----Step 9: Read all Arriba TSV files ----------------------------------------
...
# ----Step 9: Resolve compound intergenic partner annotations -----------------
...
# ----Step 9: Long-format partner table ---------------------------------------
...
# ----Step 10: Per-partner summary (full cohort) ------------------------------
...
# ----Step 11: Tumor-exclusivefiltering (n_normal == 0, n_tumor >= 1) ---------
...
# ----Step 11: (optional) Apply recurrence cutoff (n_samples_tumor >= 5) ------
